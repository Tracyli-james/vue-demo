...
export const constantRoutes = [
  ...
  //       name: 'Documentation',
  //       meta: { title: '游戏管理', icon: 'documentation', affix: true }
  //     }
  //   ]
  // },
  // {
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'EditArticle',
        meta: { title: '用户余额', noCache: true, activeMenu: '/example/list' },
        hidden: true
      },
      {
        path: 'list',
      ...
      },
      {
        ...
        // component: () => import('@/views/example/list'),
        name: '用户分析',
        meta: { title: '用户分析', icon: 'list' }
      },
      {
        path: 'test',
        // component: () => import('@/views/example/list'),
        name: '测试申请',
        meta: { title: '测试申请', icon: 'list' }
      }
    ]
  },
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        // component: () => import('@/views/error-page/404'),
        name: 'Page404',
        meta: { title: '渠道游戏管理', noCache: true }
      }
    ]
  },
